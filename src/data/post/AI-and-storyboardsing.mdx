...
<div class="grid grid-cols-2 gap-4">
  <div>
  <p>AI can revolutionize eLearning storyboarding across multiple stages, transforming it from a linear process to a dynamic, iterative, and pedagogically sound one. Here's a breakdown of how AI can be used</p>
    </div>
  <div>
  <p>AI can revolutionize eLearning storyboarding across multiple stages, transforming it from a linear process to a dynamic, iterative, and pedagogically sound one. Here's a breakdown of how AI can be used</p>
    </div>
